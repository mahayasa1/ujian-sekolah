...
<head>
    ...
    <title>Reset Password - DigiTest SELSA</title>
...
<div style="width:100%;max-width:360px;">
    ...
    <div style="text-align:center;margin-bottom:28px;">
        <div style="font-size:26px;font-weight:800;color:#1C1C1E;letter-spacing:-0.5px;margin-bottom:4px;">Reset Password</div>
        <div style="font-size:13px;color:#8E8E93;line-height:1.4;">Masukkan password baru untuk<br>akun kamu</div>
    </div>
