...
<head>
    ...
    <title>Konfirmasi Password - DigiTest SELSA</title>
...
<div style="width:100%;max-width:360px;">
    ...
    <div style="text-align:center;margin-bottom:28px;">
        <div style="font-size:26px;font-weight:800;color:#1C1C1E;letter-spacing:-0.5px;margin-bottom:4px;">Konfirmasi Password</div>
        <div style="font-size:13px;color:#8E8E93;line-height:1.4;">Ini area aman. Konfirmasi password<br>kamu sebelum melanjutkan</div>
    </div>
    ...
    <form method="POST" action="{{ route('password.confirm.store') }}">
        ...
        <div style="display:flex;align-items:center;gap:8px;margin-bottom:24px;margin-top:10px;">
            <input
                type="checkbox"
                id="show_pwd"
